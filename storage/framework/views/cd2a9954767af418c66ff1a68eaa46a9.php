...
<body>
    ...
    <div class="shelf">
        <?php $__currentLoopData = $books2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="book">
            <div class="img">
                <img src="/uploads/<?php echo e($book->image); ?>" alt="">
                <div class="title">
...
</html><?php /**PATH F:\Users\HP\Desktop\example-app\htdocs\laptop-app - Copy\resources\views/welcome.blade.php ENDPATH**/ ?>