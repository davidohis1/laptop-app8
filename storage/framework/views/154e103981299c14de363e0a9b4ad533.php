...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('css/dash.css')); ?>">
</head>
<body>
    <div id="head">
        <nav>
    ...
    <div class="allbook">
        <div class="book1">
            <div class="input10">
                <form action="<?php echo e(route('dashboardpost2')); ?>" method="post">
                <?php echo csrf_field(); ?>
        ...
        <div class="book2">
            ...
            <form method="post" action="<?php echo e(route('dashboardpost')); ?>" enctype="multipart/form-data" class="form100">
                <?php echo csrf_field(); ?>
            <div class="book20">
                <div class="form10">
                    <div class="input11">
                    ...
                    <?php $total = 0 ?>
                        <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($details->buyer); ?></td>
...
</html><?php /**PATH C:\Users\HP\Desktop\example-app\htdocs\laptop-app - Copy\resources\views/dash.blade.php ENDPATH**/ ?>